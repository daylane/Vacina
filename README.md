# Projeto de Gerenciamento de Vacinas
...
- POST /api/vacinas/vacinasmock: Faz injestão de dados no banco de dados local
...
- POST /api/vacinas/registrarvacina : Cria uma nova vacina com os dados enviados no corpo da requisição
- PUT /api/vacinas/atualizarVacina/{id} : Atualiza a vacina com o id especificado com os dados enviados no corpo da requisição
- DELETE /api/vacinas/{id} : Deleta a vacina com o id especificado
